...
function handleEditInterview(id) {
    var InterId=document.getElementById('interid');
    InterId.innerHTML=`ID => ${id[0]}`;
    console.log("handle " + id[0]);
...
// ****************************************** Show Upcoming Interviews Box ********************************


const showInterviewsBtn = document.querySelector('.show-btn-box button');
const interviewsList = document.querySelector('.outer-container');
const closeInterviewsList = document.querySelector('.outer-container .close div');

showInterviewsBtn.addEventListener("click", ()=>{
    interviewsList.setAttribute("style", "display:block");
    showInterviewsBtn.setAttribute("style", "display:none");
});

closeInterviewsList.addEventListener("click", ()=>{
    showInterviewsBtn.setAttribute("style", "display:flex; justify-content:center;");

    interviewsList.setAttribute("style", "display:none;");
})
